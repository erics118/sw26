...
INSERT INTO clients (id, created_at, name, company, email, phone, nationality, vip, risk_flag, notes) VALUES
  (c_cl6, '2024-07-10 10:00:00+00', 'Alex Chen', 'TechVenture Inc', 'alex@techventure.com', '+1 (650) 555-0123', 'US', true, false, 'Tech CEO, West Coast, prefers light aircraft'),
  (c_cl7, '2024-08-22 14:00:00+00', 'Maria Santos', 'Oceanview Resort', 'maria@oceanview.com', '+1 (561) 555-0456', 'BR', false, false, 'Resort owner, Caribbean trips, groups 4-6'),
  (c_cl8, '2024-10-05 09:00:00+00', 'David Goldman', 'Apex Capital', 'dgoldman@apexcap.com', '+1 (212) 555-0789', 'US', true, false, 'Hedge fund, NYC, same-day flights common'),
  (c_cl9, '2024-11-18 11:00:00+00', 'Robert Knight', 'Knight Sports Group', 'rk@knightsports.com', '+1 (214) 555-0234', 'US', true, true, 'Sports team owner, 12+ pax, payment delays history'),
  (c_cl10, '2025-01-06 16:00:00+00', 'Hassan Al-Maktoum', 'Gulf Energy Co', 'hassan@gulfenergy.ae', '+971 50 555-0567', 'AE', true, false, 'Oil exec, ultra-long international, premium only');
...
LOOP
  IF r.dow IN (4, 5, 6) THEN
    ...
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl1, ('[{"from_icao":"KVNY","to_icao":"KLAS","date":"' || r.dt || '","time":"09:00"}]')::jsonb, 'one_way', 3, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      ...
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
      (v_tid, c_cl1, c_tp, 'completed', 'turboprop', 18,
        ...
        (r.dt - interval '12 days')::timestamptz);
  END IF;
END LOOP;
...
LOOP
  IF r.dow IN (1, 3, 4, 5, 6) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl2, ('[{"from_icao":"KBUR","to_icao":"KLAX","date":"' || r.dt || '","time":"10:00"}]')::jsonb, 'one_way', 4, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
LOOP
  IF r.dow IN (1, 2, 3, 4, 5, 6) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl6, ('[{"from_icao":"KSFO","to_icao":"KLAS","date":"' || r.dt || '","time":"08:00"}]')::jsonb, 'one_way', 3, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
LOOP
  IF r.dow IN (1, 2, 3, 4, 5) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl1, ('[{"from_icao":"KLAX","to_icao":"KORD","date":"' || r.dt || '","time":"09:00"}]')::jsonb, 'one_way', 6, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
    ...
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl5, ('[{"from_icao":"KTEB","to_icao":"KMIA","date":"' || r.dt || '","time":"11:00"}]')::jsonb, 'one_way', 5, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
    ...
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl4, ('[{"from_icao":"KMDW","to_icao":"KLAX","date":"' || r.dt || '","time":"08:30"}]')::jsonb, 'one_way', 7, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
LOOP
  IF r.dow IN (1, 2, 3, 4, 5) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl3, ('[{"from_icao":"KORD","to_icao":"KMIA","date":"' || r.dt || '","time":"10:00"}]')::jsonb, 'one_way', 8, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
LOOP
  IF r.dow IN (1, 4) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl3, ('[{"from_icao":"KMIA","to_icao":"KTEB","date":"' || r.dt || '","time":"10:00"}]')::jsonb, 'one_way', 10, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  ...
  IF r.dow IN (1, 3, 5, 6) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl1, ('[{"from_icao":"KJFK","to_icao":"KLAX","date":"' || r.dt || '","time":"09:00"}]')::jsonb, 'one_way', 9, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
LOOP
  IF r.dow = 5 THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl3, ('[{"from_icao":"KBOS","to_icao":"EGLL","date":"' || r.dt || '","time":"21:00"}]')::jsonb, 'one_way', 12, (r.dt - interval '14 days')::timestamptz);
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl8, '[{"from_icao":"KJFK","to_icao":"KMIA","date":"2026-01-15","time":"08:00"}]'::jsonb, 'one_way', 4, '2026-01-05 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  ...
  (v_tid, c_cl8, c_m1, 'completed', 'midsize', 20,
    ...
    '2026-01-07 14:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl6, '[{"from_icao":"KSFO","to_icao":"KLAS","date":"2026-01-22","time":"08:00"}]'::jsonb, 'one_way', 3, '2026-01-12 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl6, c_l2, 'completed', 'light', 22,
    ...
    '2026-01-14 11:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl1, '[{"from_icao":"KJFK","to_icao":"KLAX","date":"2026-02-01","time":"09:00"}]'::jsonb, 'one_way', 9, '2026-01-22 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl1, c_h2, 'completed', 'heavy', 24,
...
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl5, '[{"from_icao":"KTEB","to_icao":"KMIA","date":"2026-02-08","time":"11:00"}]'::jsonb, 'one_way', 5, '2026-01-29 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl5, c_m2, 'completed', 'midsize', 18,
    ...
    '2026-01-31 11:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl8, '[{"from_icao":"KJFK","to_icao":"KMIA","date":"2026-02-15","time":"08:00"}]'::jsonb, 'one_way', 4, '2026-02-05 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl8, c_m1, 'completed', 'midsize', 20,
    ...
    '2026-02-07 14:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl2, '[{"from_icao":"KBUR","to_icao":"KLAX","date":"2026-02-18","time":"10:00"}]'::jsonb, 'one_way', 4, '2026-02-08 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl2, c_l1, 'completed', 'light', 20,
    ...
    '2026-02-10 11:00:00+00'::timestamptz);

-- atc (4 events)
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl4, '[{"from_icao":"KORD","to_icao":"KTEB","date":"2026-02-10","time":"07:00"}]'::jsonb, 'one_way', 6, '2026-01-31 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl4, c_sm, 'completed', 'super-mid', 21,
    ...
    '2026-02-02 11:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl3, '[{"from_icao":"KORD","to_icao":"KMIA","date":"2026-01-20","time":"10:00"}]'::jsonb, 'one_way', 8, '2026-01-10 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl3, c_sm, 'completed', 'super-mid', 21,
    ...
    '2026-01-12 14:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl1, '[{"from_icao":"KLAX","to_icao":"KORD","date":"2026-01-28","time":"09:00"}]'::jsonb, 'one_way', 6, '2026-01-18 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl1, c_m1, 'completed', 'midsize', 20,
    ...
    '2026-01-20 11:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl7, '[{"from_icao":"KLAS","to_icao":"KMIA","date":"2026-02-14","time":"10:00"}]'::jsonb, 'one_way', 4, '2026-02-04 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl7, c_l2, 'completed', 'light', 20,
    ...
    '2026-02-06 14:00:00+00'::timestamptz);

-- mechanical (3 events)
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl5, '[{"from_icao":"KMIA","to_icao":"KJFK","date":"2026-02-12","time":"14:00"}]'::jsonb, 'one_way', 5, '2026-02-02 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl4, '[{"from_icao":"KMDW","to_icao":"KLAX","date":"2026-01-18","time":"08:30"}]'::jsonb, 'one_way', 7, '2026-01-08 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl4, c_m3, 'completed', 'midsize', 22,
    ...
    '2026-01-10 14:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl3, '[{"from_icao":"KMIA","to_icao":"KTEB","date":"2026-02-05","time":"10:00"}]'::jsonb, 'one_way', 10, '2026-01-26 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl3, c_h1, 'completed', 'heavy', 23,
    ...
    '2026-01-28 11:00:00+00'::timestamptz);

-- crew (3 events)
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl8, '[{"from_icao":"KJFK","to_icao":"KLAX","date":"2026-01-25","time":"08:00"}]'::jsonb, 'one_way', 5, '2026-01-15 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl8, c_m1, 'completed', 'midsize', 20,
    ...
    '2026-01-17 14:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl6, '[{"from_icao":"KSFO","to_icao":"KTEB","date":"2026-02-03","time":"06:00"}]'::jsonb, 'one_way', 3, '2026-01-24 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl6, c_l2, 'completed', 'light', 20,
    ...
    '2026-01-26 11:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl9, '[{"from_icao":"KMIA","to_icao":"KORD","date":"2026-02-17","time":"09:00"}]'::jsonb, 'one_way', 10, '2026-02-07 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl9, c_sm, 'completed', 'super-mid', 22,
    ...
    '2026-02-09 14:00:00+00'::timestamptz);

-- client (2 events)
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl2, '[{"from_icao":"KSFO","to_icao":"KLAX","date":"2026-01-12","time":"12:00"}]'::jsonb, 'one_way', 2, '2026-01-02 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl2, c_l1, 'completed', 'light', 22,
    ...
    '2026-01-04 11:00:00+00'::timestamptz);

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl10, '[{"from_icao":"OMDB","to_icao":"EGLL","date":"2026-02-07","time":"20:00"}]'::jsonb, 'one_way', 8, '2026-01-28 16:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl7, '[{"from_icao":"KMIA","to_icao":"KTEB","date":"2026-01-30","time":"14:00"}]'::jsonb, 'one_way', 6, '2026-01-20 10:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
...
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl1, '[{"from_icao":"KLAX","to_icao":"KORD","date":"2026-02-19","time":"09:00"}]'::jsonb, 'one_way', 6, '2026-02-09 09:00:00+00'::timestamptz);
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
  actual_departure_time, actual_arrival_time, actual_block_hours, actual_reposition_hours, actual_total_hours, delay_reason_code,
  scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, created_at) VALUES
  (v_tid, c_cl1, c_m1, 'completed', 'midsize', 20,
    ...
    '2026-02-11 11:00:00+00'::timestamptz);
...
LOOP
  IF r.dow IN (4, 5) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl4, ('[{"from_icao":"KVNY","to_icao":"KLAS","date":"' || r.dt || '","time":"09:00"}]')::jsonb, 'one_way', 2, now() - interval '3 days');
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, confirmed_at, created_at) VALUES
      (v_tid, c_cl4, c_tp, 'confirmed', 'turboprop', 18,
        (r.dt || ' 09:00:00+00')::timestamptz, (r.dt || ' 11:06:00+00')::timestamptz, 2.1, now() - interval '2 days', now() - interval '3 days');
  END IF;
  IF r.dow IN (1, 3, 5, 6) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl7, ('[{"from_icao":"KLAS","to_icao":"KMIA","date":"' || r.dt || '","time":"10:00"}]')::jsonb, 'one_way', 4, now() - interval '4 days');
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, confirmed_at, created_at) VALUES
      (v_tid, c_cl7, c_l2, 'confirmed', 'light', 20,
        (r.dt || ' 10:00:00+00')::timestamptz, (r.dt || ' 13:18:00+00')::timestamptz, 3.0, now() - interval '2 days', now() - interval '4 days');
  END IF;
  IF r.dow IN (1, 2, 3, 4, 5) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl8, ('[{"from_icao":"KJFK","to_icao":"KLAX","date":"' || r.dt || '","time":"08:00"}]')::jsonb, 'one_way', 5, now() - interval '5 days');
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, confirmed_at, created_at) VALUES
      (v_tid, c_cl8, c_m1, 'confirmed', 'midsize', 20,
        (r.dt || ' 08:00:00+00')::timestamptz, (r.dt || ' 12:00:00+00')::timestamptz, 4.0, now() - interval '1 day', now() - interval '5 days');
  END IF;
  IF r.dow IN (2, 4) THEN
    v_tid := gen_random_uuid();
    INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
      (v_tid, c_cl9, ('[{"from_icao":"KMIA","to_icao":"KORD","date":"' || r.dt || '","time":"09:00"}]')::jsonb, 'one_way', 10, now() - interval '6 days');
    INSERT INTO quotes (trip_id, client_id, aircraft_id, status, chosen_aircraft_category, margin_pct,
      scheduled_departure_time, scheduled_arrival_time, scheduled_total_hours, confirmed_at, created_at) VALUES
      (v_tid, c_cl9, c_sm, 'confirmed', 'super-mid', 22,
        (r.dt || ' 09:00:00+00')::timestamptz, (r.dt || ' 12:18:00+00')::timestamptz, 3.1, now() - interval '3 days', now() - interval '6 days');
  END IF;
END LOOP;

-- ════════════════════════════════════════════════════════════
-- SECTION 5: QUOTE LIFECYCLE (new, pricing, sent, negotiating, lost)
-- Includes round-trip with separate departure/return flexibility
-- ════════════════════════════════════════════════════════════

-- Round-trip with different flex: fixed outbound (±0), flexible return (±4)
v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, flexibility_hours, flexibility_hours_return, created_at) VALUES
  (v_tid, c_cl6, '[{"from_icao":"KSFO","to_icao":"KTEB","date":"2026-03-12","time":"08:00"},{"from_icao":"KTEB","to_icao":"KSFO","date":"2026-03-14","time":"18:00"}]'::jsonb, 'round_trip', 4, 0, 4, now() - interval '1 day');
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, margin_pct, created_at) VALUES
  (v_tid, c_cl6, c_l2, 'new', 20, now() - interval '1 day');

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl10, '[{"from_icao":"OMDB","to_icao":"EGLL","date":"2026-03-10","time":"20:00"}]'::jsonb, 'one_way', 8, now() - interval '2 days');
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, margin_pct, created_at) VALUES
  (v_tid, c_cl10, c_ul, 'new', 25, now() - interval '2 days');

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl6, '[{"from_icao":"KSFO","to_icao":"KTEB","date":"2026-03-05","time":"06:00"}]'::jsonb, 'one_way', 3, now() - interval '5 days');
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, margin_pct, notes, created_at) VALUES
  (v_tid, c_cl6, c_l2, 'pricing', 20, 'Calculating fuel/crew costs', now() - interval '5 days');

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl7, '[{"from_icao":"KMIA","to_icao":"KTEB","date":"2026-03-02","time":"14:00"}]'::jsonb, 'one_way', 6, now() - interval '7 days');
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, margin_pct, sent_at, created_at) VALUES
  (v_tid, c_cl7, c_m2, 'sent', 19, now() - interval '2 days', now() - interval '7 days');

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl9, '[{"from_icao":"KORD","to_icao":"KLAX","date":"2026-03-08","time":"07:00"}]'::jsonb, 'one_way', 12, now() - interval '8 days');
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, version, margin_pct, sent_at, notes, created_at) VALUES
  (v_tid, c_cl9, c_sm, 'negotiating', 2, 17, now() - interval '3 days', 'Client wants discount', now() - interval '8 days');

v_tid := gen_random_uuid();
INSERT INTO trips (id, client_id, legs, trip_type, pax_adults, created_at) VALUES
  (v_tid, c_cl2, '[{"from_icao":"KSFO","to_icao":"KLAX","date":"2026-02-28","time":"12:00"}]'::jsonb, 'one_way', 2, now() - interval '12 days');
INSERT INTO quotes (trip_id, client_id, aircraft_id, status, margin_pct, sent_at, notes, won_lost_reason, created_at) VALUES
  (v_tid, c_cl2, c_l1, 'lost', 22, now() - interval '5 days', 'Lost to competitor', 'competitor', now() - interval '12 days');

-- ════════════════════════════════════════════════════════════
-- SECTION 6: QUOTE COSTS (for sent/negotiating from Section 5)
-- ════════════════════════════════════════════════════════════

INSERT INTO quote_costs (quote_id, fuel_cost, fbo_fees, repositioning_cost, repositioning_hours, permit_fees, crew_overnight_cost, catering_cost, peak_day_surcharge, subtotal, margin_amount, tax, total, per_leg_breakdown)
SELECT q.id, 4200, 800, 600, 0.5, 0, 0, 350, 0, 5950, 1064, 0, 7014,
...
INSERT INTO quote_costs (quote_id, fuel_cost, fbo_fees, repositioning_cost, repositioning_hours, permit_fees, crew_overnight_cost, catering_cost, peak_day_surcharge, subtotal, margin_amount, tax, total, per_leg_breakdown)
SELECT q.id, 18500, 2400, 1800, 1.2, 450, 1200, 800, 600, 25750, 4378, 0, 30128,
...
INSERT INTO route_plans (quote_id, trip_id, aircraft_id, optimization_mode, route_legs, refuel_stops, weather_summary, notam_alerts, alternatives, cost_breakdown,
...
SELECT q.id, q.trip_id, q.aircraft_id, 'balanced',
  ...
  '[]'::jsonb, '[]'::jsonb,
  '{"fuel":4200,"fbo":800,"repositioning":600,"catering":350}'::jsonb,
...
INSERT INTO audit_logs (action, entity_type, entity_id, user_id, payload, ai_generated, ai_model, human_verified) VALUES
  ('client.created', 'clients', c_cl6, NULL, '{"name":"Alex Chen","company":"TechVenture Inc"}'::jsonb, false, NULL, true),
  ('trip.created', 'trips', NULL, '00000000-0000-0000-0000-000000000001'::uuid, '{"source":"intake","legs":1}'::jsonb, true, 'claude-sonnet-4-20250514', false),
  ('quote.sent', 'quotes', NULL, NULL, '{"status":"sent","margin_pct":19}'::jsonb, false, NULL, true),
  ('quote.completed', 'quotes', NULL, NULL, '{"delay_reason_code":"weather"}'::jsonb, false, NULL, true),
  ('forecast.override_applied', 'fleet_forecast_overrides', NULL, NULL, '{"date":"2026-03-02","category":"all","multiplier":1.55}'::jsonb, false, NULL, true);
