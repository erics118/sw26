...
-- ── USA ──────────────────────────────────────────────────────────────────────
  ...
  ('KIAH', 'George Bush Intercontinental Airport', 'Houston', 'US', 29.9844, -95.3414, 97, 12001, true, 750, true),
  ...
  ('KLGA', 'LaGuardia Airport', 'New York', 'US', 40.7769, -73.8740, 21, 7003, true, 1100, true),
  ...
  ('KSNA', 'John Wayne Airport-Orange County', 'Santa Ana', 'US', 33.6757, -117.8682, 56, 5701, true, 800, false),
  ('KISP', 'Long Island MacArthur Airport', 'Islip', 'US', 40.7952, -73.1002, 99, 7002, true, 650, false),
  ('KORF', 'Norfolk International Airport', 'Norfolk', 'US', 36.8946, -76.2012, 26, 9003, true, 600, true),
  ('KDAB', 'Daytona Beach International Airport', 'Daytona Beach', 'US', 29.1799, -81.0580, 34, 10000, true, 550, false),
  ('KSRQ', 'Sarasota Bradenton International Airport', 'Sarasota', 'US', 27.3954, -82.5544, 30, 9234, true, 600, false),
  ('KLEX', 'Lexington Blue Grass Airport', 'Lexington', 'US', 38.0365, -84.6059, 979, 7003, true, 550, false),
  ('KSDF', 'Louisville Muhammad Ali International Airport', 'Louisville', 'US', 38.1741, -85.7365, 501, 10200, true, 600, true),
  ('KMSY', 'Louis Armstrong New Orleans International', 'New Orleans', 'US', 29.9934, -90.2580, 4, 11019, true, 700, true),
  ('KAUS', 'Austin-Bergstrom International Airport', 'Austin', 'US', 30.1944, -97.6700, 542, 12250, true, 700, true),
  ('KSAT', 'San Antonio International Airport', 'San Antonio', 'US', 29.5337, -98.4691, 809, 8505, true, 600, true),
  ('KPHF', 'Newport News/Williamsburg International', 'Newport News', 'US', 37.1319, -76.4930, 42, 8003, true, 550, false),
  ('KGSO', 'Piedmont Triad International Airport', 'Greensboro', 'US', 36.0978, -79.9373, 925, 10001, true, 550, true),
  ('KAVL', 'Asheville Regional Airport', 'Asheville', 'US', 35.4362, -82.5418, 2165, 8001, true, 600, false),
  ('KCHA', 'Chattanooga Metropolitan Airport', 'Chattanooga', 'US', 35.0353, -85.2038, 683, 7200, true, 500, false),
  ('KCMH', 'John Glenn Columbus International Airport', 'Columbus', 'US', 39.9980, -82.8919, 815, 10119, true, 650, true),
  ('KCLE', 'Cleveland Hopkins International Airport', 'Cleveland', 'US', 41.4117, -81.8498, 791, 10006, true, 700, true),
  ('KMKE', 'Milwaukee Mitchell International Airport', 'Milwaukee', 'US', 42.9472, -87.8966, 723, 9696, true, 650, true),
  ('KMSN', 'Dane County Regional Airport', 'Madison', 'US', 43.1399, -89.3375, 887, 9003, true, 550, false),
  ('KDSM', 'Des Moines International Airport', 'Des Moines', 'US', 41.5340, -93.6631, 958, 9001, true, 550, true),
  ('KMCI', 'Kansas City International Airport', 'Kansas City', 'US', 39.2976, -94.7139, 1026, 10801, true, 650, true),
  ('KOKC', 'Will Rogers World Airport', 'Oklahoma City', 'US', 35.3931, -97.6007, 1295, 9802, true, 600, true),
  ('KABQ', 'Albuquerque International Sunport', 'Albuquerque', 'US', 35.0402, -106.6092, 5355, 13001, true, 650, true),
-- ── Canada ────────────────────────────────────────────────────────────────────
