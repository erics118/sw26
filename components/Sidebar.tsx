  ...
  return (
    <aside className="sidebar-in flex h-screen w-56 flex-col border-r border-zinc-800 bg-zinc-950">
      ...
      <div className="flex h-14 items-center gap-2.5 border-b border-zinc-800 px-4">
        ...
        <span className="font-logo text-[17px] leading-none font-bold tracking-wide uppercase">
          <span className="text-zinc-100">Sky</span>
      ...
      <div className="border-t border-zinc-800 p-3">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm text-zinc-600 transition-colors hover:bg-zinc-800 hover:text-zinc-300"
        >
          <svg
            width="14"
            height="14"
